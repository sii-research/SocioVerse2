...
description: Improve academic paper writing quality — ML/CV/NLP and computational-social-science papers alike — with clear section structure, paragraph flow, and reviewer-facing presentation. Use when drafting or revising Abstract, Introduction, Related Work, Method, Experiments/Results, or Conclusion; polishing figures/tables; checking claim-support alignment; or performing self-review before submission. In SocioVerse2 this is the craft layer behind /sv-paper — that skill owns the evidence contract and file layout, this one owns the writing.
---
