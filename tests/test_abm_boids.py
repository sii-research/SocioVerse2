"""End-to-end + parity for abm_boids (umbrella).

Continuous-field task with NumPy-valued context (neighbour relative positions/velocities)
and a deterministic Reynolds steering rule, so parity is exact.
"""
...
import studies.abm_boids as study  # noqa: F401  (registers abm.* providers via umbrella)
