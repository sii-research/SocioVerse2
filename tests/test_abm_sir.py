"""End-to-end + parity for abm_sir (umbrella).

SIR's rule draws per-agent random transitions (module RNG), so the parity reference
...
import studies.abm_sir as study  # noqa: F401  (registers abm.* providers via umbrella)
